...
df_final = rbind.data.frame(A_dfs, B_dfs) %>%
  ...
  select(-Filename,-max_turns_cond, -trim_turns) %>%
...
drp_results = drpdfromts(fw_quantiles_A,fw_quantiles_B,
                         ws=wsz, # this is the window size--in other words, how far the lead/lag window should be
