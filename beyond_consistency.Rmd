...
# neatly print output
pander_lme(exploratory_analyses_raw_freq)
...
# standardized: does linguistic style change based on the conversation setting?
exploratory_analyses_st_freq <- lmer(freq ~ conv.type + (1|speaker_code),
                            data = standardized_df, REML = FALSE)

# calculate 95%CI for model
CI_exploratory_analyses_st_freq <- confint(exploratory_analyses_st_freq)

# calculate effect size for model
es_exploratory_analyses_st_freq <- lme.dscore(exploratory_analyses_st_freq, 
                                     data = standardized_df, type = "lme4")
...
# print summary tables
summary(exploratory_analyses_st_freq)

# print effect sizes
es_exploratory_analyses_st_freq

# print confidence intervals
CI_exploratory_analyses_st_freq
...
# neatly print output
pander_lme(exploratory_analyses_st_freq)
...
***
##Additional analysis: RQA of pronouns and conjunctions
...
# print summary tables
summary(conj_add_analyses_RR)

# print effect sizes
es_conj_add_analyses_RR

# print confidence intervals
CI_conj_add_analyses_RR
...
# neatly print output
pander_lme(conj_add_analyses_RR)
...
# print summary table
summary(post_hoc_RR_raw_add_conj)

# print confidence intervals
CI_posthoc_RR_raw_add_conj

# print effect sizes
es_post_hoc_RR_raw_add_conj
...
# neatly print output
pander_lm(post_hoc_RR_raw_add_conj)
...
# print summary table
summary(post_hoc_RR_st_add_conj)

# print confidence intervals
CI_posthoc_RR_st_add_conj

# print effect sizes
es_post_hoc_RR_st_add_conj
...
# neatly print output
pander_lm(post_hoc_RR_st_add_conj)
