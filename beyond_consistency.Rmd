...
# print summary table
summary(h2_analyses_determinism)
...
# neatly print output
pander_lme(h2_analyses_determinism)
...
```{r silently-print-h2-st-drp-summary, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-st-real-drp-table, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-real-raw-drp-summary, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-raw-drp-table, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-partnerwise-st-drp-summary, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-partnerwise-st-drp-table, eval=TRUE, echo=FALSE}
...
```{r silently-print-h2-samplewise-st-drp-summary, eval=FALSE, echo=FALSE}
...
```{r silently-print-h2-samplewise-st-drp-table, eval=FALSE, echo=FALSE}
