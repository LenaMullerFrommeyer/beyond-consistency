...
Next, we repeat our analyses for RQA parameters indicative of LS structure and complexity
to exploratorily investigate the influence of conversational setting on aspects of 
...
namely, proporion of function words to compare the new dynamic approach to
the traditonal more static approach.
