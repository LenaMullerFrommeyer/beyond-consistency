...
```{r silently-print-posthoc-h1-rr-table, eval=FALSE}
...
```{r silently-print-posthoc-h1-det-table, eval=FALSE}
...
```{r silently-print-posthoc-h1-rentr-table, eval=FALSE}
...
### Post-hoc analysis: Normalized NRLINE

```{r post-hoc-h1-rentr-model}

# do changes in uniformity of structure of linguistic style between monologues 
# and dialogues differ by conversation type?
h1_analyses_post_NRLINE_norm = lm(Diff_NRLINE_norm ~ cond_c, 
                      data = h1_post_hoc)
...
# print summary table
summary(h1_analyses_post_NRLINE_norm)
...
# neatly print output
pander_lme(h1_analyses_post_NRLINE_norm)

```



```{r silently-plot-h1-post-retnr-data, echo=FALSE}
