...
### DRPs: Sample-wise shuffled baseline
...
```{r silently-print-h2-st-drp-summary, echo=FALSE}
...
```{r silently-print-h2-st-real-drp-table, echo=FALSE}
...
```{r plot-aggregate-real-st-drps, echo=FALSE}
...
```{r silently-print-h2-real-raw-drp-summary, echo=FALSE}
...
```{r silently-print-h2-raw-drp-table, echo=FALSE}
...
```{r plot-aggregate-real-raw-drps, echo=FALSE}
...
```{r silently-print-h2-partnerwise-st-drp-summary, echo=FALSE}
...
```{r silently-print-h2-partnerwise-st-drp-table, echo=FALSE}
...
```{r plot-aggregate-partnerwise-st-drps, echo=FALSE}
...
```{r model-h2-drp-raw-partnerwise}
...
```{r silently-print-h2-partnerwise-raw-drp-summary, eval=TRUE, echo=FALSE}

# print summary table
summary(H2_partner_raw)

```

```{r silently-print-h2-partnerwise-real-drp-table, eval=TRUE, echo=FALSE}

# neatly print output
pander_lme(H2_partner_raw)

```

```{r plot-aggregate-partnerwise-real-drps, echo=FALSE}
...
```{r model-h2-drp-st-samplewise, eval=FALSE}
...
```{r silently-print-h2-samplewise-st-drp-summary, echo=FALSE, eval=FALSE}
...
```{r silently-print-h2-samplewise-st-drp-table, echo=FALSE, eval=FALSE}
...
```{r plot-aggregate-samplewise-st-drps, echo=FALSE}
...
```{r model-h2-drp-raw-samplewise, eval=FALSE}
...
```{r silently-print-h2-samplewise-raw-drp-summary, eval=FALSE, echo=FALSE}

# print summary table
summary(H2_sample_raw)

```

```{r silently-print-h2-samplewise-real-drp-table, eval=FALSE, echo=FALSE}

# neatly print output
pander_lme(H2_sample_raw)

```

```{r plot-aggregate-samplewise-real-drps, echo=FALSE}
