...
# do the real DRP calculation here
...
# do the partner-wise shuffled DRP here
...
# do the sample-wise shuffled plot-level CRQA here

```

Need to note in the manuscript that we dropped baselines with fewer than 10
talk-turns from any DRP analyses.

**AP**: Don't forget to repeat this chunk for REAL data and for the
partner-wise shuffled baseline data!
...
for (next_conv in split_sur) {
  ...
  if (dim(next_conv)[1]>9){
    ...
    drp_for_sur = drpdfromts(next_conv$fw_quantiles_A, 
