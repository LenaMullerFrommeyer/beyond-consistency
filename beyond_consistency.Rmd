...
First, we'll do some slight recoding of the variables.

```{r prepare-variables-real}
...
```{r prepare-variables-partnerwise}
...
```{r prepare-variables-samplewise}
